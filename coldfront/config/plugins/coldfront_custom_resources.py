...
if ENABLE_GEODE_PROJECT_LDAP_INTEGRATION:
    ...
    LDAP_GEODE_PROJECT_CONNECT_TIMEOUT = ENV.int("LDAP_GEODE_PROJECT_CONNECT_TIMEOUT", 3)
...
LDAP_SLATE_PROJECT_CONNECT_TIMEOUT = ENV.int("LDAP_SLATE_PROJECT_CONNECT_TIMEOUT", 3)
...
if ENABLE_LDAP_ELIGIBILITY_SERVER:
    ...
    LDAP_ELIGIBILITY_CONNECT_TIMEOUT = ENV.int("LDAP_ELIGIBILITY_CONNECT_TIMEOUT", 3)
