...
EMAIL_PROJECT_EXPIRING_NOTIFICATION_DAYS = ENV.list(
    "EMAIL_PROJECT_EXPIRING_NOTIFICATION_DAYS", cast=int, default=[7, 14, 30]
)
...
EMAIL_RESOURCE_EMAIL_TEMPLATES = ENV.dict("EMAIL_RESOURCE_EMAIL_TEMPLATES", default={})
