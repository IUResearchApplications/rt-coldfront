...
class AnnouncementCreateView(LoginRequiredMixin, UserPassesTestMixin, FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["mailing_lists"] = {
            mailing_list.pk: mailing_list.name for mailing_list in AnnouncementMailingListChoice.objects.all()
        }
...
class AnnouncementUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["initial_mailing_lists_selected"] = list(
            announcement_obj.mailing_lists.all().values_list("pk", flat=True)
        )
