            ...
            for username, role in selected_users.items():
                ...
                if allocation_obj.allocationuser_set.filter(user=user_obj).exists():
                    ...
                    allocation_user_obj = AllocationUser.objects.create(
                        allocation=allocation_obj, user=user_obj, status=allocation_user_status_choice, role=role
                    )
...
class AllocationAttributeUpdateView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def test_func(self):
        ...
        messages.error(self.request, "You do not have permission to update attributes in this allocation.")
        ...
        if formset.is_valid():
            for entry in formset:
                ...
                if new_value and new_value != allocation_attribute.value:
                    ...
                    create_admin_action(request.user, {"value": new_value}, allocation_obj, allocation_attribute)
